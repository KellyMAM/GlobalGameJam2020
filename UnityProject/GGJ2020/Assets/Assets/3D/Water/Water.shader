Shader "Unlit/SimpleWater"
{
    Properties
    {
        _WaterTint("Water Tint", Color) = (1, 1, 1, .5)
        _FoamTint("Foam Tint", Color) = (1, 1, 1, .5)
        ...
        _Foam("Foamline Thickness", Range(0,3)) = 0.5
         _FoamStep("Foam Step", Range(0,3)) = 0.5
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                fixed4 frag(v2f i) : SV_Target
                {
                    ...
                    half4 col = tex2D(_MainTex, i.uv) * _WaterTint;// texture times tint;
                    ...
                    //foamLine = smoothstep(foamLine, _FoamStep, _FoamStep);

                    if (length(foamLine) > _FoamStep)
                    {
                        col = /*foamLine **/ _FoamTint; // add the foam line and tint to the texture
                    }
